...
{
	public class IranAppsPurchaseValidator : IPurchaseValidator
	{
		private const string TOKEN_URL = "http://api.iranapps.ir/v2/auth/token";
		private const string VALIDATE_URL = "http://api.iranapps.ir/v2/applications/{0}/purchases/products/{1}/tokens/{2}?access_token={3}";
		private const string AUTHORIZE_URL = "http://api.iranapps.ir/v2/auth/authorize";
		...
		public IranAppsPurchaseValidator(string PackageName, string ClientID, string ClientSecret, string RefreshToken)
		{
